...
- Updates S.B(values in reference table)
  ...
  - Set Null
    - Sets R.A to null
  - Cascade - propagates change to any referencing values. - if S.B changes any tuple referencing B will update its value - are cascading changes expensive?
    Do these actions work in reverse? Can we update R.A and that change S.B

TODO: Take this and create test of conbstraints, but this is a good one to drop
